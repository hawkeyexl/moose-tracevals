...
role: TypeScript engineer building tooling on top of agentevals
...
Rin maintains internal tooling, or an open-source agent framework, and has decided agentevals is
...
**How they use agentevals:** as a dependency. They register a grader at startup, run the engine
