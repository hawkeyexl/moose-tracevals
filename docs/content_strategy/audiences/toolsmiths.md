...
id: aud-toolsmiths
type: audience
segment: Toolsmiths building on agentevals
maturity: cross-cutting
docs_owner: they own code that imports agentevals
...
# Audience: Toolsmiths building on agentevals

**Scope:** people writing code that imports agentevals, beyond invoking its CLI: custom graders,
...
Extend agentevals instead of reimplementing it: add a check the built-ins do not cover, consume
