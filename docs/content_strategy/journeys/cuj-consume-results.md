...
entry_point: /tracevals/ci/consume-results/
...
steps:
  - { stage: "Emit machine-readable output", doc: /tracevals/ci/consume-results/, exists: true }
  - { stage: "Parse the report structure", doc: /tracevals/reference/report-and-exit-codes/, exists: true }
  - { stage: "Track runs over time", doc: "/tracevals/ci/consume-results/#track-runs-over-time", exists: true }
  - { stage: "Detect a regression between runs", doc: "/tracevals/ci/consume-results/#detect-a-regression", exists: true }
  - { stage: "Publish a human-readable summary", doc: "/tracevals/ci/exit-codes-and-reports/#keep-the-report", exists: true, note: "the markdown reporter" }
  - { stage: "Call the library instead of the CLI", doc: /tracevals/extend/, exists: true }
---
...
**Narrative.** This is the journey where tracevals stops being a pass/fail gate and becomes a
