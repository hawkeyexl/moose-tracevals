...
steps:
  - { stage: "Read one result line", doc: /tracevals/triage/, exists: true, note: "artifact, criterion, and outcome defined in place" }
  - { stage: "Understand a deterministic failure", doc: "/tracevals/triage/#a-check-failed", exists: true, note: "the finding names what the session did" }
  - { stage: "Weigh a judged verdict", doc: "/tracevals/triage/#a-judged-verdict", exists: true, note: "the vote split and the cited observation are the evidence" }
  - { stage: "Decode needs-review", doc: "/tracevals/triage/#review-is-not-a-failure", exists: true }
  - { stage: "Decode the several reasons for skipped", doc: "/tracevals/triage/#why-something-was-skipped", exists: true }
  - { stage: "Tell an error from a failure", doc: "/tracevals/triage/#error-means-the-check-broke", exists: true, note: "including a malformed criteria block, which carries a line number" }
  - { stage: "Decide: fix the session, fix the criterion, or escalate", doc: "/tracevals/triage/#what-to-do-next", exists: true }
  - { stage: "Answer a follow-up question", doc: /tracevals/triage/faq/, exists: true }
---
