...
entry_point: /tracevals/get-started/
...
steps:
  - { stage: "Understand what is being checked", doc: /tracevals/, exists: true }
  - { stage: "Install and confirm the CLI runs", doc: /tracevals/get-started/, exists: true }
  - { stage: "Find an evaluable session", doc: "/tracevals/get-started/#find-a-session", exists: true, note: "tracevals list; where the session store lives" }
  - { stage: "Run the first evaluation offline", doc: "/tracevals/get-started/#run-your-first-evaluation", exists: true, note: "--deterministic-only, then --provider mock" }
  - { stage: "Read the report", doc: "/tracevals/get-started/#read-the-report", exists: true }
  - { stage: "Understand artifact coverage", doc: /tracevals/declare/coverage/, exists: true }
  - { stage: "Look up a flag", doc: /tracevals/reference/cli/, exists: true }
---
