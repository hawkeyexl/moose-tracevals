...
scope: Proposed IA for the moose-tracevals documentation site (content under docs/src/content/docs/), designed CUJ-first
...
|---|---|---|
| Get started | `get-started/` | `/moose-tracevals/get-started/` |
| Declare what to check | `declare/` | `/moose-tracevals/declare/` |
| Run it in CI | `ci/` | `/moose-tracevals/ci/` |
| Trust the judge | `judge/` | `/moose-tracevals/judge/` |
| Read a failing eval | `triage/` | `/moose-tracevals/triage/` |
